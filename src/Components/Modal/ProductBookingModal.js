                ...
                <div className="modal-box relative">
                    ...
                    <form onSubmit={handleBooking}>
                        <div className="space-y-4">
                            ...
                            <div className='grid lg:grid-cols-2 gap-2 font-semibold'>
                                <div className='flex gap-2'>
                                    ...
                                    <p className='text-innova'>Sale Price: ${resalePrice}</p>
                                </div>
                                <p>Product Condition: <span className='text-innova'>{productCondition}</span></p>
                                <p>Purchase Year: <span className='text-innova'>{purchaseYear}</span></p>
                                <p>Sold By: <span className='text-innova'>{sellerName}</span></p>
                                <p>Used Duration: <span className='text-innova'>{usedYear ? usedYear : 'Not Found'}</span></p>
                            </div>
                            {/* Product information section end */}

                            {/* Buyer Information section start */}
                            <h3 className='text-2xl font-semibold text-innova'>Buyer Information</h3>
                        ...
                        <div className='flex justify-center my-5'>
                            <button type='submit' className='bg-innova text-white font-semibold py-3 px-10 rounded'>Book Product</button>
                        </div>
                    </form>
                </div>
            </div>
