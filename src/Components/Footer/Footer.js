...
const Footer = () => {
    return (
        <div className='bg-accent text-white mt-5'>
           <div className='w-10/12 mx-auto grid grid-cols-2 md:grid-cols-4 gap-10 py-10'>
            <div>
                <div className='mb-5'>
                    <img src={logo} alt='Innova' className='w-32'/>
                    <p className='font-semibold'>
                        Innova is Online Based Resale Marketplace. 
            ...
            <div>
                ...
                <div className='my-5'>
                    <ul>
                        ...
                        <li className='flex items-center gap-1 mb-2'><FaEnvelope/><Link>care@innova.com</Link></li>
                    </ul>
                </div>
            </div>
           </div>
           ...
           <div className='py-3 text-center'>
            <p>&copy; Innova Market Inc. 2023</p>
           </div>
        </div>
    );
};
