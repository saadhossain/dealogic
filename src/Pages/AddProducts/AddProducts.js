    ...
    const handleAddProduct = (e) => {
        ...
        fetch('https://api.imgbb.com/1/upload?key=ee7085d23184f77801d3c6950c563d75', {
            ...
            .then(data => {
                ...
                fetch('https://dealogic.vercel.app/products', {
                    method: 'POST',
                    headers: {
        ...
        <div className='w-full flex flex-col p-6 rounded-lg bg-slate-50 text-gray-700 shadow-xl'>
            ...
            <form onSubmit={handleAddProduct}>
                ...
                <div className='flex justify-center my-5'>
                    <button type='submit' className='bg-dealogic duration-500 ease-in-out hover:bg-secondary text-white font-semibold py-3 px-10 rounded'> Add Product</button>
                </div>
            </form>
        </div>
    );
