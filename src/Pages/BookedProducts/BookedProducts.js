    ...
    return (
        <div>
            <div className='relative'>
                <h1 className='text-xl lg:text-4xl font-bold text-innova mb-10'>Booked Products</h1>
                <div className='border-2 border-innova w-20 absolute top-8 left-[300px]'></div>
            </div>
            <div>
