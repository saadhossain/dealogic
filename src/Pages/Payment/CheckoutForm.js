...
const CheckoutForm = ({ product }) => {
    ...
    useEffect(() => {
        ...
        fetch("https://innova-server.vercel.app/payment-intent", {
            method: "POST",
    ...
    return (
        <div className='w-full'>
            <form onSubmit={handleSubmit}>
                ...
                />
                <button type="submit" disabled={!stripe || !clientSecret} className={`${!stripe || !clientSecret ? 'bg-secondary' : 'bg-innova'} py-2 px-3 rounded text-white font-semibold my-3`}>
                    Confirm Payment
                </button>
            </form>
