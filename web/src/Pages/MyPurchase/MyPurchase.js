    ...
    return (
        <div>
            <div className='relative'>
                <h1 className='text-xl lg:text-4xl font-bold text-dealogic mb-10'>My Purchases</h1>
                <div className='border-2 border-dealogic w-20 absolute top-8 left-60'></div>
            </div>
            <div>
                                ...
                                >
                                    ...
                                    <td className='flex items-center gap-1'>
                                        <Link to={`/dashboard/payment/${myPurchase._id}`}>
                                            <button
                                                className={`duration-300 py-1 px-2 rounded text-white font-semibold ${myPurchase.payment === 'Paid' ? 'bg-accent' : 'bg-dealogic hover:bg-secondary'}`}
                                    ...
                                    <td>
                                        <button className='text-dealogic hover:text-red-700 duration-300 flex items-center'><FaTrash></FaTrash> Cancel</button>
                                    </td>
                                </tr>)
                            }
                        </tbody>
